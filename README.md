...
1. PowerShell
    ...
    1. https://github.com/AWtnb/PowerShell
        - `ghq get https://github.com/AWtnb/PowerShell`
1. ghq
    - `scoop install ghq`
1. [CorvusSKK](https://nathancorvussolis.github.io/)
    ...
    1. `ghq get https://github.com/AWtnb/CorvusSKK`
    1. [設定](./corvusskk.md)
...
1. Syncthing ([github.com/Martchus/syncthingtray](https://github.com/Martchus/syncthingtray))
    ...
    1. [設定](./syncthing.md)
1. keyhac
    - `ghq get https://github.com/AWtnb/keyhac`
1. cfiler
    - `ghq get https://github.com/AWtnb/cfiler`
